...
public class CircularByteBuffer {
	 ...
	 *
	 * @return number of bytes actually got from this buffer (0 if no bytes are
	 *         available)
	 */
	 ...
	 *
	 * @return number of bytes actually put into this buffer (0 if the buffer is
	 *         full)
	 */
	...
	/**
	 * Return the first byte a <b>get</b> would return or -1 if no data is
	 * available.
	 */
	 ...
	 *
	 * @return number of bytes actually skipped from this buffer (0 if no bytes are
	 *         available)
	 */
	...
	/**
	 * Returns the number of free bytes available that can still be put without
	 * additional gets.
	 */
